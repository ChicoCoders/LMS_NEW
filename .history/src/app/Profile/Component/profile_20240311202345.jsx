...
import { HomeOutlined,EditOutlined,DeleteOutlined ,CameraOutlined  } from '@ant-design/icons';
...
function Profile() {
  ...
  return (
      ...
      <><EditOutlined prefix={<UserOutlined />}  onClick={()=>showModal() } />
      ...
      <Modal open={previewOpen} title={previewTitle} footer={null} onCancel={handleCancel}>
        ...
        />
          ...
          <Col md={18} sm={24} xs={24}>
            <Descriptions   title={<div>Profile<Link href=" " onClick={openModal}><span ><EditOutlined /></span></Link></div>} layout="horizontal" column={{
               xs: 1,
               sm: 2,
               md: 2,
               lg: 2,
