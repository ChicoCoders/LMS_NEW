...
function UserAddForm(props) {
    ...
    <div>
                    <Form  align="center" form={props.form} size='small' layout='vertical' name="nest-messages"  >
                    ...
                    <Col xs={24} sm={18}>
                        ...
                        <Row gutter={[30,10]}>
                            ...
                            <Col xs={24} sm={12}><Form.Item name='phone' label="No of the User"> <InputNumber value={addedby} onChange={value=>SetAddedBy(value)}/></Form.Item></Col>
                        </Row>
                        <Row gutter={[30,10]}>
