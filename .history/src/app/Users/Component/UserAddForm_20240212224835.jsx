    ...
    <div>
                    ...
                    <Col xs={24} sm={18}>
                        ...
                        <Row gutter={[30,10]}>
                            ...
                            <Col xs={24} sm={12}><Form.Item name="password" label="Password" rules={[{ required: true }]}><Password value={password} onChange={(e)=>SetPassword(e.target.value)}/></Form.Item></Col>
                        </Row>
                        <Row gutter={[30,10]}>
                        ...
                        <Row gutter={[30,10]}>
                            <Col xs={24} sm={12}><Form.Item name='address' label="Address"> <Select defaultValue={usertype} value={usertype} onChange={value=>SetUserType(value)}
                                 options={[
                                            {
                                            value: 'admin',
                                            label: 'Admin',
                            ...
                            <Col xs={24} sm={12}><Form.Item name='phone' label="Phone Number"> <InputNumber value={addedby} onChange={value=>SetAddedBy(value)}/></Form.Item></Col>
                        </Row>
                        <Row gutter={[30,10]}>
