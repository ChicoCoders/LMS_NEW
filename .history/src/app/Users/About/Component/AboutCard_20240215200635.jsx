...
<div>
        ...
        <Button href="/Users" type='primary' style={{margin:" 0 20px 20px 0"}} shape='circle' icon={<EditOutlined />}></Button>
      <Button type='primary' shape='circle' icon={<DeleteOutlined/>}></Button>
        ...
        <Row gutter={[30,30]} align="middle" justify="center">
         ...
         />
              ...
              <EditPopupCard visible={isPopupVisible} onClose={closePopup} />
              </Flex>
